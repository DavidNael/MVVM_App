...
class _$_RegisterObject implements _RegisterObject {
  ...
  @override
  String toString() {
    return 'RegisterObject(username: $username, countryCode: $countryCode, mobileNumber: $mobileNumber, profilePicture: $profilePicture, email: $email, password: $password)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, username, countryCode,
      mobileNumber, profilePicture, email, password);
